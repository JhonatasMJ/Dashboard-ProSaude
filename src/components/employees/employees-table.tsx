          ...
          {!isLoading && !error && meta ? (
            <>
              ...
              <span className="font-medium text-foreground/70">
                · {totalCount} {totalCount === 1 ? "funcionário" : "funcionários"}
              </span>
            </>
          ) : null}
        </>
      ...
      filters={
        <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:gap-4">
          <div className={cn(FILTER_FIELD_WRAPPER_CLASS, "min-w-0 flex-1")}>
            <label htmlFor="employee-name-filter" className={FILTER_FIELD_LABEL_CLASS}>
              Buscar funcionário
            </label>
        ...
        <Table>
          <TableHeader>
            <TableRow className={DATA_TABLE_HEADER_ROW_CLASS}>
              ...
              <TableHead className={`hidden md:table-cell ${DATA_TABLE_HEAD_CLASS}`}>CPF</TableHead>
              <TableHead className={`hidden lg:table-cell ${DATA_TABLE_HEAD_CLASS}`}>Empresa</TableHead>
              <TableHead className={`hidden xl:table-cell ${DATA_TABLE_HEAD_CLASS}`}>Cargo</TableHead>
              <TableHead className={`hidden 2xl:table-cell ${DATA_TABLE_HEAD_CLASS}`}>Nascimento</TableHead>
              <TableHead className={`hidden 2xl:table-cell ${DATA_TABLE_HEAD_CLASS}`}>Idade</TableHead>
