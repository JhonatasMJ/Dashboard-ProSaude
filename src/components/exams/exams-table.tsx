...
function ExamRow({
  ...
  return (
    ...
    >
      ...
      <TableCell className="hidden max-w-[200px] truncate px-5 py-4 text-sm text-muted-foreground xl:table-cell">
        {exam.notes || "—"}
      </TableCell>
      <TableCell className="px-5 py-4">
    ...
    <>
      <Card className="gap-0 overflow-hidden rounded-sm border border-border bg-white py-0 shadow-sm ring-0">
        <div className="flex flex-col gap-4 border-b border-border bg-muted/20 px-5 py-5">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Catálogo de exames por empresa.
            ...
            <Button
              ...
              size="lg"
              onClick={openCreate}
              disabled={!canCreate || isLoadingCompanies}
          ...
          {!canCreate && !isLoadingCompanies && (
            <p className="text-sm text-amber-700">
              Cadastre pelo menos uma empresa antes de adicionar exames.
            </p>
          )}
        </div>
            ...
            <div className="space-y-1">
              ...
              <p className="max-w-sm text-sm text-muted-foreground">
                {canCreate
                  ...
                  : "Cadastre uma empresa para poder vincular exames."}
              </p>
            </div>
            {canCreate && (
              <Button
